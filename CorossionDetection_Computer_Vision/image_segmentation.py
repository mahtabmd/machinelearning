...
img = cv2.imread('mtb_images/corossion_image_sample/6.jpg')
...
labeled_img = cv2.imread('mtb_images/corossion_image_annotation/6_annotation_bgr.tiff')
...
#df.to_csv("corossion_dataset.csv")
...
# from sklearn.svm import LinearSVC
#model = LinearSVC(max_iter=1000, dual=False)  #Default of 100 is not converging
...
filename = "corossion_model_gabor_rf"
...
plt.imsave('segmented_corossion_RF_100_estim.jpg', segmented, cmap='jet')
